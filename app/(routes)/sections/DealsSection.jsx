...
const products = {
  superDeals: [
    { title: "Accent chair crafted from", price: 18550, oldPrice: 26550, image: "/chair.png" },
    { title: "Accent chair crafted from", price: 18550, oldPrice: 26550, image: "/chair.png" },
    { title: "Accent chair crafted from", price: 18550, oldPrice: 26550, image: "/chair.png" },
    { title: "Accent chair crafted from", price: 18550, oldPrice: 26550, image: "/chair.png" },
  ],
  megaDeals: [
    { title: "Accent chair crafted from", price: 18550, oldPrice: 26550, image: "/sofa.png" },
    { title: "Accent chair crafted from", price: 18550, oldPrice: 26550, image: "/sofa.png" },
    { title: "Accent chair crafted from", price: 18550, oldPrice: 26550, image: "/sofa.png" },
    { title: "Accent chair crafted from", price: 18550, oldPrice: 26550, image: "/sofa.png" },
  ],
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-6">
      <div className="bg-rose-200 p-4 rounded-lg">
        <h2 className="text-center text-2xl font-semibold italic mb-4">Super Deals</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {products.superDeals.map((p, idx) => (
            <div key={idx} className="bg-rose-100 p-4 rounded-lg shadow-sm">
      ...
      <div className="bg-yellow-100 p-4 rounded-lg">
        <h2 className="text-center text-2xl font-semibold italic mb-4">Mega Deals</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
