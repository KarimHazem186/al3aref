  ...
  return (
    <div className="px-6 py-10 relative">
      ...
      <div className="relative">
        ...
        {/* Navigation Arrows */}
        <button className="swiper-button-prev absolute -left-6 top-1/2 -translate-y-1/2 bg-white shadow-md p-2 rounded-full z-10 hover:bg-gray-100 transition">
          <FaChevronLeft />
        </button>
        <button className="swiper-button-next absolute -right-6 top-1/2 -translate-y-1/2 bg-white shadow-md p-2 rounded-full z-10 hover:bg-gray-100 transition">
          <FaChevronRight />
        </button>
      </div>
    </div>
